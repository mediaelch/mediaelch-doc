...
*Snapshots* can be downloaded `here <https://mediaelch-downloads.ameyering.de/snapshots/>`_ .
Please note that snapshot versions are **not** stable.  APIs may not work as expected.
...
**Supported systems are:**
  ...
  - openSUSE Tumbleweed, 15.5 and later
...
.. |mirror_snapshot_macOS_11_or_later| image:: images/badges/macOS-dev.svg
   :target: https://mediaelch-downloads.ameyering.de/snapshots/macOS_11_or_later/

.. |mirror_snapshot_macOS_X| image:: images/badges/macOS-dev.svg
   :target: https://mediaelch-downloads.ameyering.de/snapshots/macOS_X/

.. |mirror_snapshot_windows_7_8| image:: images/badges/Windows-dev.svg
   :target: https://mediaelch-downloads.ameyering.de/snapshots/Windows_7_8/

.. |mirror_snapshot_windows_10_or_later| image:: images/badges/Windows-dev.svg
